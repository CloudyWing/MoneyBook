...
namespace MoneyBook.Web {
    public class EmailService : IIdentityMessageService {
        public Task SendAsync(IdentityMessage message) {
            ...
            WebMail.UserName = "cloudywingtest2@gmail.com";
            WebMail.Password = "WingTest";
    ...
    public class ApplicationUserManager : UserManager<ApplicationUser> {
        ...
        public static ApplicationUserManager Create(IdentityFactoryOptions<ApplicationUserManager> options, IOwinContext context) {
            ...
            if (manager.FindByEmail("yearningwing@gmail.com") == null) {
                var user = new ApplicationUser() {
                    UserName = "yearningwing@gmail.com",
                    Nickname = "雲翼",
                    Email = "yearningwing@gmail.com",
                    EmailConfirmed = true
                };
                manager.Create(user, "UseMoneyBook");
                manager.AddToRole(user.Id, Role.Administrator);
            }
    ...
    public class ApplicationRoleManager : RoleManager<IdentityRole> {
        ...
        public static ApplicationRoleManager Create(IdentityFactoryOptions<ApplicationRoleManager> options, IOwinContext context) {
            ...
            if (!manager.Roles.Any()) {
                manager.Create(new IdentityRole { Name = Role.Administrator });
                manager.Create(new IdentityRole { Name = Role.Member });
            }
